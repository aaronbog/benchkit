...
class PlatformInfo(ABC):
    ...
    def generate(cls,commandlineInterface:ActiveCommandlineInterface) -> 'PlatformInfo':
        ...
        if commandlineInterface.run_command_struct(SingleCommand("systeminfo")).is_sucsess():
            #probably in a windows system
            if commandlineInterface.run_command_struct(SingleCommand("ver")).is_sucsess():
            ...
            versionResult = commandlineInterface.run_command_struct(SingleCommand("cat /proc/version"))
