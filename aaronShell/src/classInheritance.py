...
async def run_client() -> None:
    opt = asyncssh.SSHClientConnectionOptions(username='yoyoyoyo')
    conn, client = await asyncssh.create_connection(MySSHClient, 'ftp.mynameisace.online',57429,options=opt)
...
if False:
    ...
    samuPy = CommandlineInterface.remoteInterface(hostname="ftp.mynameisace.online",port=57429,username="yoyoyoyo")
