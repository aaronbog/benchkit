...
from tests.command_execution.execute_command.util import TestTimeout, fd_checker, generate_test_hook_lists, get_arguments_dict_list, print_open_fds, script_path_string, thread_checker, timeout
...
class FunctionalExecutionTests(unittest.TestCase):
    ...
    def test_dir(self) -> None:
        ...
        with fd_checker(),thread_checker():
            for arguments in arguments_list:
                # hook based argumens
                hooklist = generate_test_hook_lists(force_output=True)
                for input_hooks,output_hooks,result_hook_object in hooklist:
